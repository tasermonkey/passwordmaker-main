...
If you want, you may submit it to us to add for future releases. All this script does is replace replace some text in two files (and display the form to create the bookmarklet).
To allow for easy sharing of the form itself, the form may be split from the PHP as another file.
