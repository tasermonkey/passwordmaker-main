...
/*
	This is a bandaid solution until someone can give decent support for mhash on Windows.
	Plus side is that HMAC-SHA256 will be correct with the Javascript version ;)
*/
...
function getHash(algo, data, encoding, key, trim) {
	...
	case "hmac-sha256":
		return PasswordMaker_SHA256.any_hmac_sha256(key, data, encoding, trim);
	default:
		return '';
	}
}
...
if (typeof(PasswordMaker_SHA256) != "object") {
	var PasswordMaker_SHA256 = {
		...
		any_hmac_sha256: function(k, d, e, t){ return PasswordMaker_HashUtils.rstr2any(this.rstr_hmac_sha256(PasswordMaker_HashUtils.str2rstr_utf8(k), PasswordMaker_HashUtils.str2rstr_utf8(d)), e, t); },
