...
if (typeof(PasswordMaker_SHA256) != "object") {
    ...
    any_hmac_sha256: function(k, d, e){ return PasswordMaker_HashUtils.rstr2any(this.rstr_hmac_sha256(PasswordMaker_HashUtils.str2rstr_utf8(k), PasswordMaker_HashUtils.str2rstr_utf8(d)), e); },
